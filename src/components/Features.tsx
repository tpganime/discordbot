...
const features = [
  ...
  {
    title: 'Global Radio',
    description: 'Access over 50,000+ radio stations from around the world directly in your voice channel.',
    icon: Radio,
    color: 'text-red-500',
    bg: 'bg-red-500/10',
  },
      ...
      <Container size="xl">
        <div className="text-center mb-32">
          ...
          <Typography variant="h2" weight="black" className="mb-8">
            Everything You Need <br /> To <span className="text-orange-600">Scale</span> Your Server
          </Typography>
          ...
          {features.map((feature, i) => (
            ...
            >
              <Card className="h-full hover:bg-white/[0.05] group cursor-pointer">
                ...
                <Typography variant="h4" weight="bold" className="mb-4 group-hover:text-orange-600 transition-colors duration-300">
                  {feature.title}
                </Typography>
