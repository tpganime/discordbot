      ...
      <main>
        ...
        <Section spacing="xl" className="relative overflow-hidden">
          <div className="absolute inset-0 z-0">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1200px] h-[600px] bg-orange-600/10 blur-[150px] rounded-full" />
          </div>
          ...
          <Container size="xl" className="relative z-10">
            <div className="glass rounded-[64px] p-16 md:p-32 text-center border border-white/5">
              <Typography variant="h2" weight="black" className="mb-8">
                Ready to <span className="text-orange-600">Fusion</span> Your Server?
              </Typography>
