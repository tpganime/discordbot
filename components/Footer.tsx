...
const Footer: React.FC = () => {
  return (
    <footer className="px-6 py-20 border-t border-white/5 mt-20 relative">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="md:col-span-1">
            <div className="flex items-center gap-3 mb-6">
              <img 
                ...
                alt="Footer Logo" 
                className="w-10 h-10 rounded-xl shadow-lg shadow-pink-500/10"
              />
              <span className="text-xl font-bold text-white truncate max-w-[200px]">{BOT_NAME}</span>
            </div>
            <p className="text-gray-500 text-sm leading-relaxed mb-6">
              Empowering Discord communities with high-quality free music, interactive games, and reliable 24/7 service.
            </p>
            <div className="flex gap-4">
              <a href="#" className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center hover:bg-white/10 transition-colors text-gray-400 hover:text-white">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-500">
              ...
              <li><a href="#" className="hover:text-pink-400 transition-colors">Status Page</a></li>
            </ul>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-white/5 text-sm text-gray-600">
          <p>© 2024 ・𒀛TPG ｜MUSIC. All rights reserved.</p>
          <p className="mt-4 md:mt-0">Made with ❤️ for the Discord community.</p>
        </div>
      </div>
    </footer>
  );
